...
[![GoDoc](https://godoc.org/github.com/DaanDD/go-binance?status.svg)](https://godoc.org/github.com/DaanDD/go-binance)
[![Go Report Card](https://goreportcard.com/badge/github.com/DaanDD/go-binance)](https://goreportcard.com/report/github.com/DaanDD/go-binance)
...
```shell
go get github.com/DaanDD/go-binance/v2
```

For v1 API, it has been moved to `v1` branch, please use:

```shell
go get github.com/DaanDD/go-binance/v1
```
...
```golang
import (
    "github.com/DaanDD/go-binance/v2"
)
```
...
Following are some simple examples, please refer to [godoc](https://godoc.org/github.com/DaanDD/go-binance) for full references.
...
```go
import (
    "github.com/DaanDD/go-binance/v2/futures"
)
...
```go
import (
    "github.com/DaanDD/go-binance/v2/delivery"
)
